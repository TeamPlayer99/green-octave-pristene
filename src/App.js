              ...
              <div className="inner">
                <nav className="right-panel-nav-bar">
                  <ul>
                    ...
                    className={ this.state.activePage === 'review' ? "active unselectable" : "notActive unselectable"}>
                      Reviews</li>
                    <li onClick={() => this.getClicked('feedback')}
                    className={ this.state.activePage === 'feedback' ? "active unselectable" : "notActive unselectable"}>
                      Feedbacks</li>
                    <li onClick={() => this.getClicked('aboutUs')}
                    className={ this.state.activePage === 'aboutUs' ? "active unselectable" : "notActive unselectable"}>
                      About us</li>
                    <li onClick={() => this.getClicked('gallery')}
                    className={ this.state.activePage === 'gallery' ? "active unselectable" : "notActive unselectable"}>
                      Gallery</li>
                  </ul>
                </nav>
